...
class _$RequestStateTearOff {
  ...
  Error<T> error<T>({required String errorMessage, StackTrace? stackTrace}) {
    return Error<T>(
...
class _$Error<T> implements Error<T> {
  const _$Error({required this.errorMessage, this.stackTrace});
  ...
  @override
  String toString() {
    return 'RequestState<$T>.error(errorMessage: $errorMessage, stackTrace: $stackTrace)';
  }
...
abstract class Error<T> implements RequestState<T> {
  const factory Error({required String errorMessage, StackTrace? stackTrace}) =
      _$Error<T>;
